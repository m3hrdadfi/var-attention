config = dict(
    ...
    encoder_num_tokens = 50, # Number of words/tokens in the input sequence # 20 for dialogue
    ...
    word_dropout_keep_probability = 1.0, # 1.0 - Word dropout rate for the decoder
    ...
    gamma_val = 0.2, # Coefficient of the attention KL loss
